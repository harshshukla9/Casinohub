...
// CasinoVault Contract Configuration
...
export const StatusL2Withdrawl = {

  contractAddress: "0x72419DF6e4B30009DeE8c1E82cBb0424f9E03503", // Update this with new deployed address
    abi : [
      {
        "inputs": [
          {
